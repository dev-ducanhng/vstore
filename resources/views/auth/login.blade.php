...
<div class=" grid grid-cols-1 lg:grid-cols-2">
    <div class="banner-lg-V w-full h-full hidden lg:block ">
        <div class="flex flex-col justify-between items-start h-full p-20">
            <h1 class="text-[#FFF] text-5xl font-extrabold">V-Store</h1>
            <div class="flex flex-col justify-start items-start gap-5">
                <h2 class="text-[#FFF] text-5xl font-extrabold">Quản lý dễ dàng <br>Bán hàng đơn giản</h2>
                <span class="text-[#FFF] text-2xl font-semibold">Hỗ trợ đăng ký 1800 0000</span>
            </div>
        </div>
    </div>
    <div class="login flex flex-col justify-start items-start gap-10 xl:px-32 p-10 px-4 lg:px-10">
        ...
        <form  method="POST" class="w-full" id="form-log">
            @csrf

            @if(Session::has('mes'))
                <p style="color: red;" class="">{{ Session::get('mes') }}</p>
            @endif
            <div class="flex flex-col justify-center items-center gap-6 w-full py-10">
                <div class="flex flex-col justify-start items-start gap-2 w-full">
                    ...
                    <input type="text" name="email" placeholder="Nhập email hoặc số điện thoại" class="usr-email outline-none w-full py-2 px-3 border-[1px] border-[#D9D9D9] bg-[#FFFFFF] focus:border-primary transition-all duration-200 rounded-sm">
                </div>
                <div class="flex flex-col justify-start items-start gap-2 w-full">
                    <span class="text-sm"><strong class="text-[#FF4D4F]">*</strong> Mật khẩu</span>
                    <div class="pass w-full relative">
                        <input type="password" name="password" placeholder="Nhập mật khẩu" class="usr-pass outline-none w-full py-2 px-3 border-[1px] border-[#D9D9D9] bg-[#FFFFFF] focus:border-primary transition-all duration-200 rounded-sm">
                        <div class="password">
            ...
            <div class="mt-24 text-center w-full flex flex-col justify-center items-center gap-10">
                <input type="submit" class="btn-log btn-ctn text-center w-full text-grey text-xl font-medium bg-btnGrey rounded-lg py-4" value="Đăng nhập"></input>
                <span class="text-xl font-medium w-full">Bạn chưa có tài khoản? <a href="../dang-ky/" class="text-primary hover:opacity-70 transition-all duration-500">Đăng ký ngay</a></span>
            </div>
